...
public class OBJExporter : ScriptableWizard
{
    ...
    public static void ExportGameObjectsToOBJ(GameObject[] objects, string exportPath)
    {
        OBJExporter exporter = ScriptableObject.CreateInstance<OBJExporter>();
    
        // 配置导出选项
        exporter.onlySelectedObjects = true;
        ...
        exporter.autoMarkTexReadable = false;
        ...
        ScriptableObject.DestroyImmediate(exporter);
    }
